...
3. Build the protection case as a documentary case. Country-conditions evidence (State Department reports, expert declarations, NGO reports, news coverage), corroborating evidence of the respondent's individual circumstances (medical records of past harm, identity documents, evidence of group membership), and a credible declaration are the standard package.
